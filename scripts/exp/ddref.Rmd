...
Analagous to all of figure 10B4, we see the effect of using this new lifespan profile estimate on the ultimate profile likelihood (mean_more_data).  Notably, the mean has shifted lower and now contains a 'double hump' a questionable shape that implies that certain intermediate values of ddref are less likely than values of either side of them!
