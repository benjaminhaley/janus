...
# TODO: make sure the counts don't have duplicates
# TODO: keep track of individual counts (or cluster counts)
# TODO: add groups to ANL data
...
table0(d$duplicates)  # 8608 TRUE, 17798 FALSE
...
# TODO: make a handy table with references so I can cross check these results
...
g <- ggplot(d %.% filter(grepl('^6977', cluster)),
       aes(lifespan, 
           color=group_id,
           group=group_id
           )) + 
