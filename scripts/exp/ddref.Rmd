...
model_10B4 <- function(data, o){    
    glm(
      I(1/age - 1/636.175) ~ I(dose + o*dose^2 / (fractions)) - 1,
      data=data[data$modeled_in_10B3,],
      weights=1/(sd^2)
    )
}

new_r <- get_likelihoods(o_range, data)
...
confidence_interval(beir_r$o + 1, beir_r$mean_likelihood, 0.05)
# is        "1.4 (1.1, 4.2)"
