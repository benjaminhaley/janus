...
count(d)
# 23 studies, 144 treatments, 39K animals
...
# 22 studies, 138 treatments, 35K animals

# Remove cases with few treatment groups    
d <- filter_by_n_groups(d)
count(d)        
# 19 studies, 126 treatments, 31K animals
...
count(d_wo_warnings)
# 14 studies, 71 treatments, 14K animals
...
d <- d %.%
  group_by(cluster) %.%
  mutate(n_observations = length(cluster))
