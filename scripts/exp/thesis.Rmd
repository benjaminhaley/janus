...
source('~/janus/scripts/util/thesis.R') # http://goo.gl/VYzkAs

# Data
original_data <- readRDS('~/janus/data/thesis.rds')
controls <- readRDS('~/janus/data/thesis_controls.rds')
```
...
ozasa_analysis <- function(name, 
  ...
  ## Get data
  data <- get_data(dose_limit = dose_limit, 
...
#                 dose_limit = 4,
#                 exclude_stratum = stratum_with_acute_poisoning)
...
###
#
# Time between first and last exposure
#
less_than_14_days_between_first_and_last_exposure_stratum <- c(1,3,16,18)
more_than_14_days_between_first_and_last_exposure_stratum <- c(2,5,6,8,9,10,11,12,14,15,17)
short_intervals <- function(data) data %>%
  filter(!stratum_id %in% more_than_14_days_between_first_and_last_exposure_stratum)

long_intervals <- function(data) data %>%
  filter(!stratum_id %in% less_than_14_days_between_first_and_last_exposure_stratum)

# < 14 day interval 
ozasa_analysis("1 - 4 Sv", dose_limit = 4, additional_filter = short_intervals)
...
#  11730 animals 115 groups 8 studies. 
# 
# After filtering excluded species:  
#  11730 animals 115 groups 8 studies. 
# 
# After filtering other exclusions:  
#  6352 animals 59 groups 6 studies. 
# 
# After censoring animals that died before the final treatment in thier strata,  
#  6180 animals 59 groups 6 studies. 
# 
...
# [1] "modeling"
#                       0.5 %    99.5 %
# dref               0.135202 0.8521602
# err_treatment_age -8.223323 2.7175765
#                        2.5 %    97.5 %
# dref               0.2054717 0.7272625
# err_treatment_age -5.7250037 0.8754876
#                          5 %      95 %
# dref               0.2407915 0.6715366
# err_treatment_age -4.7486479 0.3651684
#                          x       o    lower    upper
# r_1                1.02297 0.01501  0.99356  1.05239
# r_2                1.01154 0.01584  0.98050  1.04258
# r_3                1.06065 0.00724  1.04645  1.07484
# r_4                0.95154 0.02848  0.89572  1.00736
# r_5                0.99971 0.01612  0.96811  1.03131
# r_6                1.03074 0.02661  0.97858  1.08290
# r_7                0.99432 0.02195  0.95131  1.03734
# err_1              0.08468 0.02677  0.03220  0.13715
# err_2              0.07201 0.02221  0.02847  0.11554
# err_3              0.01334 0.00619  0.00121  0.02547
# err_4              0.11754 0.04320  0.03287  0.20222
# err_5              0.09869 0.06667 -0.03199  0.22936
# err_6              0.06085 0.04682 -0.03091  0.15261
# err_7              0.13030 0.07412 -0.01498  0.27558
# dref               0.43424 0.12650  0.18630  0.68219
# err_treatment_age -1.63041 1.23835 -4.05759  0.79676
# tau2              -0.00039 0.00000 -0.00039 -0.00039

# 1/dref = 0.43 (0.21, 0.73)
# dref = 2.30 (1.37, 4.86)

# 14+ day interval 
ozasa_analysis("1 - 4 Sv", dose_limit = 4, additional_filter = long_intervals)
...
# 
# After filtering other exclusions:  
#  7369 animals 83 groups 6 studies. 
# 
# After censoring animals that died before the final treatment in thier strata,  
#  7221 animals 83 groups 6 studies. 
# 
# After censoring animals that died within  0 % of median lifespan after the final treatment  
#  7221 animals 83 groups 6 studies. 
# 
# [1] "modeling"
#                        0.5 %   99.5 %
# dref               0.3207579 0.739249
# err_treatment_age -5.9692891 0.117055
#                        2.5 %      97.5 %
# dref               0.3562587  0.67745814
# err_treatment_age -4.6102723 -0.03535974
#                          5 %       95 %
# dref               0.3744228  0.6487494
# err_treatment_age -4.0288323 -0.1133435
#                          x       o    lower    upper
# r_1                1.03472 0.00946  1.01619  1.05325
# r_2                1.06075 0.00720  1.04663  1.07487
# r_3                1.00038 0.01104  0.97874  1.02202
# r_4                0.94993 0.04559  0.86058  1.03929
# r_5                0.95162 0.02846  0.89583  1.00740
# r_6                1.00614 0.01550  0.97576  1.03652
# r_7                0.99621 0.02739  0.94253  1.04989
# r_8                1.02982 0.01410  1.00219  1.05746
# r_9                1.00414 0.01754  0.96975  1.03852
# r_10               0.99826 0.01905  0.96093  1.03559
# r_11               0.99994 0.01608  0.96843  1.03146
# r_12               0.98825 0.02186  0.94541  1.03110
# r_13               0.98368 0.04601  0.89350  1.07386
# r_14               1.01304 0.05926  0.89689  1.12920
# err_1              0.06903 0.01899  0.03181  0.10626
# err_2              0.01346 0.00612  0.00147  0.02546
# err_3              0.02187 0.01836 -0.01412  0.05786
# err_4              0.12728 0.05040  0.02851  0.22606
# err_5              0.11763 0.04325  0.03287  0.20240
# err_6              0.08593 0.02369  0.03950  0.13237
# err_7              0.10330 0.04586  0.01341  0.19319
# err_8              0.15434 0.03369  0.08831  0.22036
# err_9              0.12556 0.02607  0.07445  0.17666
# err_10             0.08718 0.02939  0.02958  0.14478
# err_11             0.09659 0.05292 -0.00715  0.20032
# err_12             0.11856 0.03153  0.05677  0.18036
# err_13             0.18127 0.05317  0.07705  0.28548
# err_14             0.10997 0.04464  0.02248  0.19746
# dref               0.49633 0.07176  0.35567  0.63699
# err_treatment_age -1.72319 1.04681 -3.77494  0.32857
# tau2              -0.00003 0.00000 -0.00003 -0.00003

# 1/dref = 0.50 (0.36, 0.68)
# dref = 2.01 (1.48, 2.81)
...
# Mouse only
ozasa_analysis("1 - 4 Sv", dose_limit = 4, exclude_species = "Rat")
...
# 
# After filtering excluded species:  
#  8987 animals 66 groups 7 studies. 
# 
# After censoring animals that died before the final treatment in thier strata,  
#  8793 animals 66 groups 7 studies. 
# 
# After censoring animals that died within  0 % of median lifespan after the final treatment  
#  8793 animals 66 groups 7 studies. 
# 
...
# 
# (new deviance=-239.1, old deviance=-238.7, diff=-0.4209)
# 
# Returning better fit ...
# 
# [1] "modeling"
#                        0.5 %    99.5 %
# dref               0.1991222 0.9251228
# err_treatment_age -6.5608950 1.9424806
#                        2.5 %    97.5 %
# dref               0.2658426 0.7886032
# err_treatment_age -4.6249243 0.7073575
#                          5 %      95 %
# dref               0.2999803 0.7339197
# err_treatment_age -3.8275773 0.2928515
#                          x       o    lower    upper
# r_1                1.02279 0.01593  0.99157  1.05401
# r_2                1.03669 0.01124  1.01466  1.05873
# r_3                1.01040 0.01649  0.97808  1.04272
# r_4                1.05319 0.01053  1.03254  1.07383
# r_5                1.00023 0.01488  0.97107  1.02939
# r_6                0.95246 0.04922  0.85599  1.04892
# r_7                0.95275 0.03075  0.89248  1.01303
# r_8                0.99969 0.01894  0.96256  1.03683
# err_1              0.07776 0.02138  0.03585  0.11967
# err_2              0.06406 0.02113  0.02265  0.10548
# err_3              0.07031 0.01975  0.03160  0.10901
# err_4              0.01666 0.00722  0.00252  0.03081
# err_5              0.01929 0.01851 -0.01699  0.05557
# err_6              0.12600 0.04976  0.02846  0.22354
# err_7              0.11672 0.04454  0.02943  0.20401
# err_8              0.08385 0.03315  0.01888  0.14882
# dref               0.48896 0.12354  0.24682  0.73110
# err_treatment_age -1.36371 0.00340 -1.37038 -1.35704
# tau2               0.00010 0.00012 -0.00014  0.00034




# Rat only
ozasa_analysis("1 - 4 Sv", dose_limit = 4, exclude_species = "Mouse")
# Originally:  
#  14782 animals 143 groups 8 studies. 
# 
# After filtering for dose:  
...
# 
# After filtering excluded species:  
#  2743 animals 49 groups 1 studies. 
# 
# After censoring animals that died before the final treatment in thier strata,  
#  2735 animals 49 groups 1 studies. 
# 
# After censoring animals that died within  0 % of median lifespan after the final treatment  
#  2735 animals 49 groups 1 studies. 
# 
# [1] "modeling"
#                         0.5 %    99.5 %
# dref                0.2938677 0.7926101
# err_treatment_age -14.8219386 3.5295786
#                        2.5 %    97.5 %
# dref               0.3392212 0.7100047
# err_treatment_age -9.5699664 2.0889355
#                          5 %      95 %
# dref               0.3624265 0.6722088
# err_treatment_age -8.0020596 1.3518237
#                          x       o    lower    upper
# r_1                1.00617 0.01550  0.97579  1.03656
# r_2                0.99624 0.02737  0.94259  1.04988
# r_3                1.02987 0.01412  1.00220  1.05754
# r_4                1.00578 0.01780  0.97090  1.04067
# r_5                0.99858 0.01881  0.96170  1.03545
# r_6                0.98835 0.02184  0.94554  1.03115
# r_7                0.98384 0.04589  0.89390  1.07378
# r_8                1.02847 0.02707  0.97541  1.08152
# r_9                0.99321 0.02227  0.94956  1.03686
# r_10               1.01865 0.06016  0.90074  1.13655
# err_1              0.08985 0.02768  0.03560  0.14411
# err_2              0.10824 0.04958  0.01106  0.20542
# err_3              0.16132 0.04047  0.08200  0.24064
# err_4              0.13152 0.03060  0.07155  0.19150
# err_5              0.09457 0.03633  0.02336  0.16578
# err_6              0.12547 0.03679  0.05336  0.19759
# err_7              0.19280 0.06267  0.06998  0.31563
# err_8              0.06991 0.05599 -0.03983  0.17964
# err_9              0.13785 0.08099 -0.02089  0.29658
# err_10             0.11206 0.04829  0.01741  0.20670
# dref               0.49945 0.09171  0.31970  0.67921
# err_treatment_age -2.46187 2.49732 -7.35661  2.43287
# tau2              -0.52779 0.00000 -0.52779 -0.52779
