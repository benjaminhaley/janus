...
data <- name_stratum(stratum_groups, stratum_name)
data <- name_cluster(split("R2♀γ"), 1, "acute 0.27 Gy/min at 520 days old  (end of fractionated series)")
data <- name_cluster(split("R1♀γ"), 2, "acute 0.099 Gy/min at 520 days old  (end of fractionated series)")
data <- name_cluster(split("Q2♀γ"), 3, "60 over 420 days 0.0068 Gy/min  starting at 100 days old")
data <- name_cluster(split("Q1♀γ"), 4, "60 over 420 days 0.0015 Gy/min  starting at 100 days old")
