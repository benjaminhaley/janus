...
# Note: exclusion:
# I eliminated group 9 from the analysis. It has an extremely low age, 602 days
# much lower than any other treatment group, many of which had higher doses.
# Nothing in the sources indicates that there was an extereme reaction at 1 Gy
# so I am confiedent that there is something screwy about the data. Unfortunately,
# I can't figure out what that screwy thing is.
...
stratum_groups <- c(7:8, 10:11, 13:14)
data <- name_stratum(stratum_groups, stratum_name)
data <- name_cluster(c(10), 1, "acute 0.06 Gy/min")
data <- name_cluster(c(8, 11), 2, "10 over 305 days 0.06 Gy/min")
